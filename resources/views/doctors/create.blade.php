                ...
                <div class="card-body pt-0">
                    ...
                    <div class="row mb-5">
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="text" name="first_name" id="first_name" class="form-control mb-2 meta_title" value=""/>
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="text" name="qualification" id="qualification" class="form-control mb-2" value=""/>
