<x-default-layout>
    ...
    @section('title')
        {{ __('blog::categories.edit_category') }}
    @endsection

    @section('breadcrumbs')
        {{ Breadcrumbs::render('blogs.categories.edit') }}
    @endsection

    {!! Form::open(array('route' =>['admin.blogs.categories.update',$category->id], 'method'=>'patch','class'=>'form d-flex flex-column flex-lg-row' ,'id' => 'kt_blog_category_form')) !!}
        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body pt-0">
                ...
                <div class="mb-10 fv-row">
                    ...
                    <input type="text" name="name" id="name" class="form-control mb-2 meta_title meta_url @error('name') is-invalid @enderror" value="{{ old('name',$category->name) }}"/>
                ...
                <div class="mb-10 fv-row">
                    ...
                    <input type="number" name="display_order" id="display_order" class="form-control mb-2" value="{{ old('display_order',$category->display_order) }}"/>
