                ...
                <div class="card-body pt-0">
                    ...
                    <div class="row mb-5">
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="text" name="designation" id="designation" class="form-control mb-2"
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="text" name="dob" id="dob" class="form-control mb-2"
                                   value="{{ $doctor->dob }}"/>
                    ...
                    <div class="mb-5 fv-row">
                        ...
                        <textarea rows="3" class="mb-3 d-none" name="description"
                                  id="quill-editor-area">{!! $doctor->description !!}</textarea>
                    </div>
            ...
            <div class="card card-flush">
                ...
                <div class="card-body pt-0">
                    <input type="text" name="id_number" id="id_number"
                           placeholder="{{ __('doctor::doctors.id_number_text') }}" class="form-control"
            ...
            <div class="card card-flush">
                ...
                <div class="card-body pt-0">
                    <input type="number" name="display_order" id="display_order"
                           placeholder="{{ __('doctor::doctors.display_order_text') }}" class="form-control"
                           value="{{ $doctor->display_order }}"/>
                </div>
            </div>
